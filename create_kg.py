...
def json2rdf(input_file: Union[str, Path],
             output_path: Union[str, Path],
             query_path: Union[str, Path],
             sparql_anything_path: Union[str, Path],
             rdf_serialisation: str = 'TTL') -> list:
    """
    Main function for converting a JSON file into RDF, according to the MusicMeta
    ...
    input_file : Union[str, Path]
        The path (either absolute or relative) of the JSON file to be converted
        into RDF
    output_path : Union[str, Path]
...
def main() -> None:
    ...
    parser = ArgumentParser(
        description='Converter from JSON files into RDF using the SPARQL '
                    'Anything software.')

    parser.add_argument('input_file',
                        type=str,
                        help='The path (either absolute or relative) of the '
                             'JSON file to be converted into RDF')
    ...
    parser.add_argument('--sparql_anything_path',
                        ...
                        default='./sparql-anything-0.8.2.jar',
                        required=False)
    ...
    json2rdf(input_file=args.input_file,
